...
if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function h(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function g(e,t){void 0===t&&(t=!0);var n,o=new Promise(function(o){n=setTimeout(o,e,t)});return o[_]=function(){clearTimeout(n)},o}function v(e,t,n){if(!t(e))throw Error(n)}function E(e,t){var n,o=null;return F(e)?n=e:(H(e)?(o=e[0],n=e[1]):(o=e.context,n=e.fn),o&&K(n)&&F(o[n])&&(n=o[n])),{context:o,fn:n,args:t}}function b(e){for(var t=arguments.length,n=Array(t>1?t-1:0),o=1;o<t;o++)n[o-1]=arguments[o];return"production"!==process.env.NODE_ENV&&(v(e,ne,"instead of writing `yield call(delay, "+n[0]+")` where delay is an effect from `redux-saga/effects` you should write `yield delay("+n[0]+")`"),te("call",e)),ee(Y,E(e,n))}function m(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];if(console.group){var o;(o=console).group.apply(o,t)}else{var r;console.log(""),(r=console).log.apply(r,[ae+fe].concat(t)),ae+=ce}}function S(){console.groupEnd?console.groupEnd():ae=ae.substr(0,ae.length-ce.length)}function C(e){return"function"==typeof e?"".concat(e.name):"string"==typeof e?"'".concat(e,"'"):e}function T(e){return"string"==typeof e||"number"==typeof e||"boolean"==typeof e||"symbol"===t(e)||null===e||void 0===e}function O(e,t){0===e.getRootIds().length&&console.log("Saga monitor: No effects to log"),console.log(""),console.log("Saga monitor:",Date.now(),(new Date).toISOString());var n=!0,o=!1,r=void 0;try{for(var a,c=e.getRootIds()[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){w(e,a.value,t)}}catch(e){o=!0,r=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw r}}console.log("")}function w(e,t,n){var o=e.get(t),r=e.getChildIds(t),a=R(o,n);if(0===r.length){var c;(c=console)[a.logMethod].apply(c,d(a.getLog()))}else{m.apply(void 0,d(a.getLog()));var f=!0,i=!1,l=void 0;try{for(var s,u=r[Symbol.iterator]();!(f=(s=u.next()).done);f=!0){w(e,s.value,n)}}catch(e){i=!0,l=e}finally{try{
f||null==u.return||u.return()}finally{if(i)throw l}}S()}}function R(e,t){var n=e.status===Q,o=e.status===B,r=new ue(n,o,t);if(r.addLabel(e.winner?o?"✘":"✓":"").addLabel(e.label),e.root)r.addEffectType("root").resetStyle().addCall(e.saga.name,e.args).addDescResult(e);else if(G(e.effect))r.addValue(e.effect.name).addDescResult(e,!0);else if(X(e.effect))r.addEffectType("promise").resetStyle().addDescResult(e);else if($(e.effect)){var a=e.effect,c=a.type,f=a.payload;if(c===Z.TAKE)r.addEffectType("take").resetStyle().addValue(null==f.channel?f.pattern:f).addDescResult(e);else if(c===Z.PUT)r.addEffectType("put").resetStyle().addDescResult(Object.assign({},e,{result:f}));else if(c===Z.ALL)r.addEffectType("all").resetStyle().addDescResult(e,!0);else if(c===Z.RACE)r.addEffectType("race").resetStyle().addDescResult(e,!0);else if(c===Z.CALL)r.addEffectType("call").resetStyle().addCall(f.fn.name,f.args).addDescResult(e);else if(c===Z.CPS)r.addEffectType("cps").resetStyle().addCall(f.fn.name,f.args).addDescResult(e);else if(c===Z.FORK)r.addEffectType(f.detached?"spawn":"fork").resetStyle().addCall(f.fn.name,f.args).addDescResult(e);else if(c===Z.JOIN)r.addEffectType("join").resetStyle().addDescResult(e);else if(c===Z.CANCEL)r.addEffectType("cancel").resetStyle().appendData(f.name);else if(c===Z.SELECT)r.addEffectType("select").resetStyle().addCall(f.selector.name,f.args).addDescResult(e);else if(c===Z.ACTION_CHANNEL)r.addEffectType("actionChannel").resetStyle().addValue(null==f.buffer?f.pattern:f).addDescResult(e);else if(c===Z.CANCELLED)r.addEffectType("cancelled").resetStyle().addDescResult(e);else if(c===Z.FLUSH)r.addEffectType("flush").resetStyle().addValue(f).addDescResult(e);else if(c===Z.GET_CONTEXT)r.addEffectType("getContext").resetStyle().addValue(f).addDescResult(e);else{if(c!==Z.SET_CONTEXT)throw Error("Invalid effect type ".concat(c));r.addEffectType("setContext").resetStyle().addValue(f).addDescResult(e,!0)}}else r.addEffectType("unknown").resetStyle().addDescResult(e);return r}function D(){
return"undefined"!=typeof performance&&performance.now?performance.now():Date.now()}function L(e){var t=D();Object.assign(e,{end:t,duration:t-e.start})}function A(e,t){var n=he.get(e);J(t)?t.toPromise().then(function(n){t.isCancelled()?I(e):A(e,n)},function(t){return N(e,t)}):(L(n),n.status=z,n.result=t,re(n.effect)&&j(e,t))}function N(e,t){var n=he.get(e);L(n),n.status=B,n.error=t,re(n.effect)&&j(e,t)}function I(e){var t=he.get(e);L(t),t.status=Q}function j(e,t){var n=Object.keys(t)[0],o=!0,r=!1,a=void 0;try{for(var c,f=he.getChildIds(e)[Symbol.iterator]();!(o=(c=f.next()).done);o=!0){var i=c.value,l=he.get(i);l.label===n&&(l.winner=!0)}}catch(e){r=!0,a=e}finally{try{o||null==f.return||f.return()}finally{if(r)throw a}}}function x(){function e(e){d&&console[l]("%c Root saga started:",E,e.saga.name||"anonymous",e.args),he.setRootEffect(e.effectId,Object.assign({},e,{status:q,start:D()}))}function t(e){y&&console[l]("%c effectTriggered:",E,e),he.set(e.effectId,Object.assign({},e,{status:q,start:D()}))}function n(e,t){p&&console[l]("%c effectResolved:",E,e,t),A(e,t)}function o(e,t){h&&console[l]("%c effectRejected:",E,e,t),N(e,t)}function r(e){g&&console[l]("%c effectCancelled:",E,e),I(e)}function a(e){v&&console[l]("%c actionDispatched:",E,e)}var f=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},i=c({},ge,f),l=i.level,s=i.verbose,u=i.color,d=i.rootSagaStart,y=i.effectTrigger,p=i.effectResolve,h=i.effectReject,g=i.effectCancel,v=i.actionDispatch,E=["color: ".concat(u),"font-weight: bold"].join(";");return pe&&(s&&console[l]("View Sagas by executing %c$$LogSagas()",ye,"in the console"),pe.$$LogSagas=function(){return O(he,u)}),{rootSagaStarted:e,effectTriggered:t,effectResolved:n,effectRejected:o,effectCancelled:r,actionDispatched:a}}var k=function(e){return"@@redux-saga/"+e},_=k("CANCEL_PROMISE"),P=k("IO"),V=k("TASK"),M=function(e){return null!==e&&void 0!==e},F=function(e){return"function"==typeof e},K=function(e){return"string"==typeof e},H=Array.isArray,U=function(e){return e&&!H(e)&&"object"==typeof e
