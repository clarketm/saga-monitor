...
M.length||console.log(P,"No effects to log"),console.log(""),console.log("Saga monitor:",Date.now(),(new Date).toISOString()),v(t),console.log("")};l.VERSION="1.0.9",J.VERSION="1.0.9",$&&($.$$LogSagas=J),e.logSaga=J,e.default=l,Object.defineProperty(e,"__esModule",{value:!0})});